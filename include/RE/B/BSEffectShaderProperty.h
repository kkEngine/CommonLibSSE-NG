...
namespace RE
{
	...
	public:
		...
		RenderPassArray*       GetRenderPasses(BSGeometry* a_geometry, RenderMode a_renderMode, BSShaderAccumulator* accumulator) override;                     // 2A
		RenderPassArray*       GetDepthAndShadowmapRenderPasses(BSGeometry* a_geometry, RenderMode a_renderMode, BSShaderAccumulator* a_accumulator) override;  // 2B
