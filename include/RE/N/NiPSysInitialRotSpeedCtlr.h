...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysInitialRotSpeedCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysInitialRotSpeedCtlr;

		~NiPSysInitialRotSpeedCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysInitialRotSpeedCtlr) == 0x60);
}
