...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysInitialRotAngleCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysInitialRotAngleCtlr;

		~NiPSysInitialRotAngleCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysInitialRotAngleCtlr) == 0x60);
}
