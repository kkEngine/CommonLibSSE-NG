...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysModifierBoolCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysModifierBoolCtlr;

		~NiPSysModifierBoolCtlr() override;  // 00
		...
		// add
		virtual void GetControlledValue(bool& value) const = 0;  // 3E
		virtual void SetControlledValue(bool value) = 0;         // 3F
	};
	static_assert(sizeof(NiPSysModifierBoolCtlr) == 0x60);
}
