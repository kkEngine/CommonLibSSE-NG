...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterDeclinationCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterDeclinationCtlr;

		~NiPSysEmitterDeclinationCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterDeclinationCtlr) == 0x60);
}
