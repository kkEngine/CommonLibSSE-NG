...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysFieldMagnitudeCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysFieldMagnitudeCtlr;

		~NiPSysFieldMagnitudeCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysFieldMagnitudeCtlr) == 0x60);
}
