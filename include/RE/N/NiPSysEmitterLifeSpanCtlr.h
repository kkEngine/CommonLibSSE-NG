...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterLifeSpanCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterLifeSpanCtlr;

		~NiPSysEmitterLifeSpanCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterLifeSpanCtlr) == 0x60);
}
