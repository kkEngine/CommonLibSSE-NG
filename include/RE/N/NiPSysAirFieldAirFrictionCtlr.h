...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysAirFieldAirFrictionCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysAirFieldAirFrictionCtlr;

		~NiPSysAirFieldAirFrictionCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysAirFieldAirFrictionCtlr) == 0x60);
}
