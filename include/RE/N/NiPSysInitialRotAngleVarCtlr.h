...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysInitialRotAngleVarCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysInitialRotAngleVarCtlr;

		~NiPSysInitialRotAngleVarCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysInitialRotAngleVarCtlr) == 0x60);
}
