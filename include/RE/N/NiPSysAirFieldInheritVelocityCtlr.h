...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysAirFieldInheritVelocityCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysAirFieldInheritVelocityCtlr;

		~NiPSysAirFieldInheritVelocityCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysAirFieldInheritVelocityCtlr) == 0x60);
}
