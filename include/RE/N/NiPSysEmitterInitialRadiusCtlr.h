...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterInitialRadiusCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterInitialRadiusCtlr;

		~NiPSysEmitterInitialRadiusCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterInitialRadiusCtlr) == 0x60);
}
