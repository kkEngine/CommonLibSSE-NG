...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysInitialRotSpeedVarCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysInitialRotSpeedVarCtlr;

		~NiPSysInitialRotSpeedVarCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysInitialRotSpeedVarCtlr) == 0x60);
}
