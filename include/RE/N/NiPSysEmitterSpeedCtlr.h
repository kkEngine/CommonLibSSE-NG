...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterSpeedCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterSpeedCtlr;

		~NiPSysEmitterSpeedCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterSpeedCtlr) == 0x60);
}
