...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysFieldMaxDistanceCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysFieldMaxDistanceCtlr;

		~NiPSysFieldMaxDistanceCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysFieldMaxDistanceCtlr) == 0x60);
}
