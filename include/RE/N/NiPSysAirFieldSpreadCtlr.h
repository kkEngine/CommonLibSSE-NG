...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysAirFieldSpreadCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysAirFieldSpreadCtlr;

		~NiPSysAirFieldSpreadCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysAirFieldSpreadCtlr) == 0x60);
}
