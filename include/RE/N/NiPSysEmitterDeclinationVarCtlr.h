...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterDeclinationVarCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterDeclinationVarCtlr;

		~NiPSysEmitterDeclinationVarCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterDeclinationVarCtlr) == 0x60);
}
