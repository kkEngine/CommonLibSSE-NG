...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysEmitterPlanarAngleCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysEmitterPlanarAngleCtlr;

		~NiPSysEmitterPlanarAngleCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysEmitterPlanarAngleCtlr) == 0x60);
}
