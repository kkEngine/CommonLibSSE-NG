...
namespace RE
{
	...
	{
	public:
		inline static constexpr auto RTTI = RTTI_NiPSysGravityStrengthCtlr;
		inline static constexpr auto Ni_RTTI = NiRTTI_NiPSysGravityStrengthCtlr;

		~NiPSysGravityStrengthCtlr() override;  // 00
	...
	static_assert(sizeof(NiPSysGravityStrengthCtlr) == 0x60);
}
